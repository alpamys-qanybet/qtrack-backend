...
//
//
//@ServerEndpoint("/infotable/{client-id}")
//public class InfotableEventSocketMediator {
//
...
//
//        try {
//            session.getBasicRemote().sendText("good to be in touch Infotable " + clientId);
//            session.getBasicRemote().sendText(kioskBean.messageOnLaunchInfotable());
//        } catch (IOException e) {
//        } catch (JSONException e) {
////            e.printStackTrace();
//        }
